...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.LayoutAttribute(typeof(StylesLayout))]
    [Microsoft.AspNetCore.Components.RouteAttribute("/styles/{Style}")]
    [Microsoft.AspNetCore.Components.RouteAttribute("/styles/{Style}/{Id}")]
    public partial class StyleDetail : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 8 "/Users/antoinebendafi/Sites/localhost/dotnet_6.0.400_blazor_intro/VoyagesFront /Pages/StyleDetail.razor"
    ...
    private static string AvecMajuscule(string s) => $"{s.Substring(0, 1).ToUpper()}{s.Substring(1)}";
